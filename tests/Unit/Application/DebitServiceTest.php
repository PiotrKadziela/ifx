...
use App\Application\DebitService;
...
class DebitServiceTest extends TestCase
{
    use ProphecyTrait;
    ...
    public function testExecuteRequest()
    {
        ...
        $account->addDebit($amount)->shouldBeCalled();
        ...
        (new DebitService($accountRepository->reveal()))->execute(
            new DebitRequest(self::ACCOUNT_ID, $amount)
        );
    }
}